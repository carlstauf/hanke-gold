...
export const LIVE_NEWS_POOL = [
  { source: "Reuters", title: "Gold dips as dollar strengthens ahead of Fed minutes", summary: "Spot gold fell 0.3% to $2,320.15 per ounce.", impact: -0.3 },
  { source: "Bloomberg", title: "China's gold consumption rises 6% in Q1", summary: "Jewelry and investment demand remains strong despite high prices.", impact: 0.5 },
  { source: "Kitco", title: "Silver breakout could pull gold higher", summary: "Technical analysis suggests silver leading the complex.", impact: 0.2 },
  { source: "CNBC", title: "US Treasury yields tick higher, weighing on metals", summary: "10-year yield up 3 basis points to 4.45%.", impact: -0.4 },
  { source: "WSJ", title: "Central banks remain net buyers of gold in April", summary: "Emerging markets continue diversification away from USD.", impact: 0.6 },
  { source: "Mining.com", title: "Newmont reports production delays at major mine", summary: "Supply constraints could support prices in medium term.", impact: 0.3 },
  { source: "Financial Times", title: "Safe-haven flows return amidst geopolitical unease", summary: "Investors flock to gold as tensions escalate.", impact: 0.7 },
  { source: "ForexLive", title: "DXY testing key resistance at 105.00", summary: "Stronger USD is a headwind for XAU/USD today.", impact: -0.5 },
];